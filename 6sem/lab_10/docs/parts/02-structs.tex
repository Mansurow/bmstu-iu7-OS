...
\captionsetup{singlelinecheck = false, justification=raggedright}
\lstinputlisting[label=lst:lst-3, caption=Первая программа, language=c]{../src/testCIO.c}
...
\captionsetup{singlelinecheck = false, justification=raggedright}
\lstinputlisting[label=lst:lst-5, caption=Третья программа с fopen, language=c]{../src/test_fopen.c}
...
\captionsetup{singlelinecheck = false, justification=raggedright}
\lstinputlisting[label=lst:lst-7, caption=Третья программа с open, language=c]{../src/test_open.c}

\clearpage

\captionsetup{singlelinecheck = false, justification=raggedright}
\lstinputlisting[label=lst:lst-8, caption=Результат работы третьей программы с open, language=bash]{structs/3-2.txt}
